...
if __name__ == "__main__":
    ...
    for method in ["baseline", "madry", "robust", "mix"]:
        ...
        args.prefix = "test5/" + args.method + ""
        args.epochs = 50
        print(args)
        print("saving file to {}".format(args.prefix))
        setproctitle.setproctitle(args.prefix)
        train_log = open(args.prefix + "_train.log", "w")
        rotation_test_log = open(args.prefix + "_rotation_test.log", "w")
        ...
        for _ in range(0,args.cascade):
            ...
            for t in range(args.epochs):
                ...
                rotation_err = evaluate_rotations(test_loader, model[0], args.epsilon,
                                           t, rotation_test_log, args.verbose)
                err = rotation_err

                start_time = datetime.datetime.now() - time_diff

                print(time_diff.total_seconds(), rotation_err ,file=full_test_log)
