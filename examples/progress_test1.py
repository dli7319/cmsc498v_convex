...
for i, val in enumerate(baseline_arr):
    ...
    baseline_arr2[i][1] = re.match(
        "tensor\(([\d\.]*),", baseline_arr2[i][1]).group(1)
    baseline_arr2[i][2] = re.match(
        "tensor\(([\d\.]*),", baseline_arr2[i][2]).group(1)
...
for i, val in enumerate(madry_arr):
    ...
    madry_arr2[i][1] = re.match(
        "tensor\(([\d\.]*),", madry_arr2[i][1]).group(1)
    madry_arr2[i][2] = re.match(
        "tensor\(([\d\.]*),", madry_arr2[i][2]).group(1)
...
for i, val in enumerate(robust_arr):
    ...
    robust_arr2[i][1] = re.match(
        "tensor\(([\d\.]*),", robust_arr2[i][1]).group(1)
    robust_arr2[i][2] = re.match(
        "tensor\(([\d\.]*),", robust_arr2[i][2]).group(1)
